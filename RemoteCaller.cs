...
namespace Cabinink
{
   ...
   public class RemoteCaller
   {
      ...
      protected virtual object OpenNative(Uri nativeUrl)
      {
         ...
         if (IsMustProtocol)
         {
            if (type.GetInterface("Cabinink.IRemoteCallProtocol`1", true) == null)
            {
      ...
      protected virtual Process OpenLocalFile(Uri fileOrDirectoryUrl) => Process.Start(fileOrDirectoryUrl.LocalPath);
